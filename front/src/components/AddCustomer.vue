    ...
    <div>
        <div v-if="!submitted">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="login" required name="login" v-model="customer.login">
          </div>
          <div class="mb-3">
            <label for="password" class="form-label">Password</label>
            <input type="text" class="form-control" id="password" required name="password" v-model="customer.password">
          </div>
          <div class="mb-3">
